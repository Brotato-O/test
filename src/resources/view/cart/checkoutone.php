...
?>
    <form action="index.php?act=orderone " method="post"  onsubmit="return validateForm()">
        <div class="row">
            <div class="col">
...
function validateForm() {
    ...
    let payment = document.querySelector("select[name='thanhtoan']").value;
    ...
    // Phone số hợp lệ (10-11 số, chỉ số)
