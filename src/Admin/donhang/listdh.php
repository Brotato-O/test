                ...
                ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="indexadmin.php?act=in_hoadon&order_id=<?php echo $order_id ?>" target="_blank"><input
                                    class="mb-2 text-bg-primary rounded" type="button" name="" value="In hóa đơn" id=""></a>
